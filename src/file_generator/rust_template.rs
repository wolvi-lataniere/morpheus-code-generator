...
const FILE_HEADER: &str = r#"// This file is autogenerated, please do not edit manually
use std::convert::TryInto;
use serde_derive::Serialize;
"#;

pub fn build_rust_source(
    file_name: String,
    ...
    file.write_all(
        codes
            ...
            .filter_map(|(_k, code)| {
                code.instruction
                    .clone()
                    .map(|inst| format!("{}{}", code.name, map_inst_feed_rust(&inst)))
            })
            .collect::<Vec<String>>()
            .join(",\n\t")
            .as_bytes(),
                        ...
                        .map(|param| {
                            [
                                match param.data_type {
                                    ...
                                    ParameterType::Int8 | ParameterType::Uint8 => "&[".as_bytes(),
